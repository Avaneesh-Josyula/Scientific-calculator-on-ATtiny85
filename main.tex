...
\author{
\IEEEauthorblockN{EE25BTECH11030-Josyula G S Avaneesh \and EE25BTECH11054-Harsha Soma Vardhan}
}
...
The code is present in the \href{run:https://github.com/Avaneesh-Josyula/Scientific-calculator-on-ATtiny85/tree/main/codes/blink/src}{\texttt{codes/blink/src}} 
directory under the name \textit{main.c}
...
The code is present in the \href{run:https://github.com/Avaneesh-Josyula/Scientific-calculator-on-ATtiny85/tree/main/codes/button_matrix/src}{\texttt{codes/button\_matrix/src}} 
directory under the name \textit{main.c}
...
The code is present in the \href{run:https://github.com/Avaneesh-Josyula/Scientific-calculator-on-ATtiny85/tree/main/codes/main/src}{\texttt{codes/main/src}} 
directory under the name \textit{main.c}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{./pics/circuitpic.jpeg}
