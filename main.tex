...
The code is present in the \fbox{\parbox{\linewidth}{\url{https://github.com/Avaneesh-Josyula/Scientific-calculator-on-ATtiny85/tree/main/codes/blink/src}}} 
...
The code is present in the \fbox{\parbox{\linewidth}{\url{https://github.com/Avaneesh-Josyula/Scientific-calculator-on-ATtiny85/tree/main/codes/button_matrix/src}}} 
directory under the name \textit{main.c}
...
The code is present in the \fbox{\parbox{\linewidth}{\url{https://github.com/Avaneesh-Josyula/Scientific-calculator-on-ATtiny85/tree/main/codes/main/src}}} 
directory under the name \textit{main.c}
