...
The code is present in the $codes/blink/src$ directory under the name $main.c$
...
The code is present in the $codes/button\_matrix/src$ directory under the name $main.c$
...
The code is present in the $codes/main/src$ directory under the name $main.c$
